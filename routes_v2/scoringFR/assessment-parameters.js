...
const columns = [
  { class: 'p-2', label: 'S.No', key: 'sNo' },
  { class: 'p-2', label: 'Ranking  Indicators', key: 'rankingIndicators' },
  { class: 'p-2', label: 'Unit', key: 'unit' },
  { class: 'p-2', label: 'Maximum  Score', key: 'maximumScore' },
  {
    class: 'p-2',
    label: 'Formula for computation of indicator',
    key: 'formula',
  },
  {
    class: 'p-2',
  ...
  { class: 'p-2', label: 'Scoring Logic', key: 'scoringLogic' },
];
      ...
      data: [
        {
          sNo: '1',
          rankingIndicators:
            'Total Budget size per capita (Actual Total Receipts)',
          unit: 'INR',
          maximumScore: '100',
          financialYears: '2021-22',
          dataSource: 'Annual budget 2023-24',
          formula:
            '[Total budget size (actual receipts) - total receipts for water supply and sanitation]/ ULB Population',
          scoringMethodology:
            '(ULB number/ Highest ULB number) * Maximum score',
        ...
        },
        {
          ...
          dataSource: 'Annual budget 2023-24',
          formula:
            '[Total own revenues - own revenues from water supply and sanitation]/ ULB Population',
        ...
        },
        {
          ...
          dataSource: 'Annual budget 2023-24',
          formula:
            '[Total property tax - tax revenues from water supply and sanitation]/ ULB Population',
          scoringMethodology: '---same as above---',
          scoringLogic: 'Higher the better',
        },
        {
          sNo: '4',
          rankingIndicators:
            'Growth (3-Year CAGR) in Total Budget Size (Total actual receipts)',
          unit: '%',
          maximumScore: '100',
          ...
          scoringMethodology:
            '[(ULB number - Lowest ULB number)/ (Highest - Lowest)] * Maximum Score',
          scoringLogic: 'Higher the better',
        },
        {
          sNo: '5',
      ...
      data: [
        {
          ...
          formula:
            '[Total capital expenditure - capex for water supply and sanitation]/ ULB Population',
          scoringMethodology:
            '(ULB number/ Highest ULB number) * Maximum score',
          scoringLogic: 'Higher the better',
        },
        ...
        },
        {
          sNo: 9,
          rankingIndicators:
            'O&M expenses to Total Revenue Expenditure (TRE) (3-year average)',
          unit: '%',
          maximumScore: 100,
          financialYears: '2019-20 to 2021-22',
          dataSource: 'Annual budgets 2021-22 to 2023-24',
          formula:
            '[Total O&M expenditure - O&M for water supply and sanitation]/ Total Revenue expenditure',
          scoringMethodology:
            '(ULB number/ Highest ULB number) * Maximum score',
          scoringLogic: 'Higher the better',
        },
      ...
      data: [
        {
          sNo: 10,
          rankingIndicators:
            "Timely Audit Closure & Publication of Audited Annual Accounts in public domain (on Cityfinance.in/ ULB's own website), for 3 years",
          unit: 'Yes/ No',
          maximumScore: 50,
          financialYears: '2019-20 to 2021-22',
          dataSource:
            'Audited accounts 2019-20 to 2021-22 and Self-reported by ULB',
          formula:
            'Calculation in two parts (25 marks each):\n(1). For Timely Audit - Average number of months taken by ULB in closing audit (i.e. Date of audit report minus date of FY close), average of 3-year period;\n(2). For Publication of Annual Accounts - Availability for last 3 years on Cityfinance/Own website (Yes/ No)',
          scoringMethodology:
            '(1). Audit closure within 12 months of FY end= 25; for>12 months= 0;\n(2). Yes= 25; No= 0',
          scoringLogic: 'Binary',
        },
        {
          sNo: 11,
          rankingIndicators:
            'Property Tax & Accounting System followed - Manual vs IT - based?',
          unit: 'Yes/ No',
          maximumScore: 50,
        ...
        },
        {
          sNo: 12,
          rankingIndicators:
            'Budget vs. Actual (Variance %) for Total Receipts (3-year average)',
          unit: '%',
          maximumScore: 50,
          financialYears: '2019-20 to 2021-22',
          dataSource: 'Annual budgets 2019-20 to 2023-24',
          formula:
            '(Actual Total Receipts – BE^ Total Receipts)/ BE^ Total Receipts (^Budget Estimate)',
          scoringMethodology:
            'If Variance % is: -10% to +20%= 100% of max score | Above +20%= 90% of max score | -25% to -10%= 80% of max score | Below -25%= proportionate based on scale of 75% of max score',
        ...
        },
        {
          ...
          dataSource: 'Self-reported by ULB',
          formula:
            '(Total own revenue arrears as on 31st March 2022/ Total own revenues for FY 2021-22) * 365',
          scoringMethodology:
            '[(Maximum ULB number - ULB number)/ (Highest - Lowest)] * Maximum score',
          scoringLogic: 'Lower the better',
        },
        {
          sNo: 14,
          rankingIndicators:
            'Digital Own Revenue Collection (DORC) to Total Own Revenue Collection (TORC)',
          unit: '%',
          maximumScore: 50,
          financialYears: '2021-22',
          dataSource: 'Self-reported by ULB',
          formula:
            '(Digital own revenue collection/ Total own revenue collection)',
          scoringMethodology:
            '(ULB number/ Highest ULB number) * Maximum score',
          scoringLogic: 'Higher the better',
        },
        {
          ...
          dataSource: 'Self-reported by ULB',
          formula:
            '[Properties from which property tax was collected during FY 2021-22/ (Total no. of assessed properties as on 31st March 2022 – Total no. of exempt properties as on 31st March 2022)]',
          scoringMethodology:
            '(ULB number/ Highest ULB number) * Maximum score',
          scoringLogic: 'Higher the better',
        },
