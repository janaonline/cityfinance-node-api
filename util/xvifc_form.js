...
let keyDetailsForm1 = {
    ...
    capExp: {
        ...
        info: 'Capital expenditure is expenditure on new fixed asset/ infrastructure projects or that has the effect of improving the capacity, efficiency, life span or economy of operations of an existing asset. Capital expenditure can be taken from receipts & payments statement or the balance sheet',
        required: true,
        year: 8,
        autoSumValidation: '',
        logic: '',
    ...
    accInCashBasis: {
        ...
        formFieldType: 'radio',
        options: [
            { id: 'Yes (Please specify)', showInputBox: true },
            { id: 'No' }
        ],
        reason: '',
        key: 'accInCashBasis',
    ...
    revReceiptRecord: {
        ...
        options: [
            ...
            { id: 'Both (Please specify which transactions are recognised in accrual basis)', showInputBox: true },
        ],
        reason: '',
    ...
    onlineAccSysIntegrate: {
        ...
        formFieldType: 'radio',
        options: [
            { id: 'Yes (Please specify which all system, e.g., tax collection, payroll, asset management)', showInputBox: true },
            { id: 'No' },
        ],
        reason: '',
