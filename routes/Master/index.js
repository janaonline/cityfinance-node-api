...
const {
    categoryList,
    subCategoryList,
    categoryFileUploadList,
    fileUpload,
    getUrbanReformsStateList,
    downloadMunicipalBondRepositoryFile,
} = require('./service');
const {
...
router.get('/municipalBondRepository/download/:_id', downloadMunicipalBondRepositoryFile);
