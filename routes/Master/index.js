...
const { categoryList, subCategoryList, categoryFileUploadList,uploadFile } = require('./service');
const {
    create, update
...
router.post('/municipalBondRepository/uploadFile',verifyToken,uploadFile);
