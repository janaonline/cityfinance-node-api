...
module.exports = async (req, res, next) => {
    try {
        ...
        let revenueExpenditureCode = ["210", "220", "230", "240", "250", "260", "270", "271", "272", "200"];
        for (let q of req.body.queryArr) {
            ...
            for (let d of q.data) {
                ...
                query = [
                    ...
                    {
                        $group: {
                            _id: { financialYear: "$financialYear", range: "$range", ulb: "$ulb" },
                            ownRevenue: {
                                $sum: {
                            ...
                            revenueExpenditure: {
                                $sum: {
                                    $cond: [{ $in: ["$code", revenueExpenditureCode] }, "$amount", 0]
                                }
                            },
                        ...
                        $project: {
                            ...
                            ownRevenuePercentageUlB: {
                                $cond: [
                                    ...
                                    {
                                        $multiply: [
                                            { $divide: ["$ownRevenue", "$revenueExpenditure"] }, 100
                                        ]
                                    },
                                    0
                                ]
