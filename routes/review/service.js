        ...
        case CollectionNames.annual:
          ...
          if (data?.actionTakenByRole === "STATE") {
            auditedEntity = ` ${data?.design_year?.year ?? ""}, ${entity?.formStatus ?? ""
              ...
              }, ${auditedProvisional?.bal_sheet?.rejectReason ?? ""}, , ,  ${auditedProvisional?.assets ?? ""
              ...
              }, ${auditedProvisional?.bal_sheet_schedules?.status ?? ""}, ${auditedProvisional?.bal_sheet_schedules?.rejectReason ?? ""
              }, , ,${auditedProvisional?.inc_exp?.pdf?.url ?? ""}, ${auditedProvisional?.inc_exp?.excel?.url ?? ""
              }, ${auditedProvisional?.inc_exp?.status ?? ""}, ${auditedProvisional?.inc_exp?.rejectReason ?? ""
              ...
              }, ${auditedProvisional?.inc_exp_schedules?.status ?? ""}, ${auditedProvisional?.inc_exp_schedules?.rejectReason ?? ""
              }, , ,${auditedProvisional?.cash_flow?.pdf?.url ?? ""}, ${auditedProvisional?.cash_flow?.excel?.url ?? ""
              }, ${auditedProvisional?.cash_flow?.status ?? ""}, ${auditedProvisional?.cash_flow?.rejectReason ?? ""
            ...
            unAuditedEntity = `${data?.design_year?.year ?? ""}, ${entity?.formStatus ?? ""
              ...
              }, ${unAuditedProvisional?.inc_exp?.status ?? ""}, ${unAuditedProvisional?.inc_exp?.rejectReason ?? ""
              ...
              }, ${unAuditedProvisional?.cash_flow?.status ?? ""}, ${unAuditedProvisional?.cash_flow?.rejectReason ?? ""
            ...
            auditedEntity = ` ${data?.design_year?.year ?? ""}, ${entity?.formStatus ?? ""
              ...
              }, ${auditedProvisional?.auditor_report?.rejectReason ?? ""}, ${data?.audited?.submit_standardized_data ?? ""
              }, ${auditedStandardized?.excel?.url ?? ""} , ${actions["auditedResponseFile_state"]["url"] ?? ""
              },${actions["auditedResponseFile_mohua"]["url"] ?? ""} `;
            unAuditedEntity = `${data?.design_year?.year ?? ""}, ${entity?.formStatus ?? ""
              }, ${data?.createdAt ?? ""}, ${data?.ulbSubmit ?? ""},${entity?.filled_provisional ?? ""
              }, Provisional,${data?.unAuditedYear?.year ?? ""}, ${unAuditedProvisional?.bal_sheet?.pdf?.url ?? ""
              }, ${unAuditedProvisional?.bal_sheet?.excel?.url ?? ""
              }, , ,  ${unAuditedProvisional?.bal_sheet?.status ?? ""}, ${unAuditedProvisional?.bal_sheet?.rejectReason ?? ""
              },  ${unAuditedProvisional?.assets ?? ""}, ${unAuditedProvisional?.f_assets ?? "" ?? ""
              }, ${unAuditedProvisional?.s_grant ?? ""}, ${unAuditedProvisional?.c_grant ?? ""
              }, ${unAuditedProvisional?.bal_sheet_schedules?.pdf?.url ?? ""
              }, ${unAuditedProvisional?.bal_sheet_schedules?.excel?.url ?? ""
